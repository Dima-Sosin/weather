...
export const Search = () => {
    ...
    return (
        <div className="flex flex-col max-w-[600px] w-full relative">
            <div className="flex flex-col justify-center relative">
                <input
                    ...
                    className="relative bg-transparent border-2 placeholder-white rounded-2xl text-2xl text-center outline outline-0 focus:outline-0"
                />
